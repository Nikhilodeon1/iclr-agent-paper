...
own schedule gives a displacement whose maximum falls at $T=8{,}000$, inside the observed peak
region, while setting the weight decay to zero makes it rise monotonically through
...
%       and the N=64 SGD rise 0.14->0.25 / p=0.26. (A pooled rank correlation was
%       removed: its sign for SGD flips with the pooling choice, because N=256/1024
%       sit at the ceiling for both optimizers and contribute only tie-noise.);
...
does reproduce the shape: with decoupled weight decay its maximum falls at
$T=8{,}000$, within the observed peak region of $2{,}000$--$8{,}000$ (whose two means,
$0.52$ and $0.49$, we cannot separate), and it declines thereafter; with the weight
decay removed the decline disappears entirely. What it does not reproduce is the size of the decline,
